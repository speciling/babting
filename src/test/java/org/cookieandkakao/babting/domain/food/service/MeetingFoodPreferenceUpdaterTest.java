...
class MeetingFoodPreferenceUpdaterTest {
    ...
    void 모임별선호비선호음식_수정하기_테스트() {
        ...
        FoodCategory foodCategory1 = new FoodCategory("양식");
        FoodCategory foodCategory2 = new FoodCategory("양식");
        FoodCategory foodCategory3 = new FoodCategory("양식");

        Food food1 = new Food(1L, foodCategory1, "Category1");
        Food food2 = new Food(2L, foodCategory2, "Category1");
        Food food3 = new Food(3L, foodCategory3, "Category2");
